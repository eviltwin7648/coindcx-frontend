export const Security = () => {
  ...
  const Block = (item: { img: string; title: string; description: string }) => (
    <div className="text-left space-y-3">
      <img src={item.img} alt={item.title} className="h-15 w-15" />
  ...
  return (
    <>
      <section className="py-16 px-4 md:px-52 bg-[#f8f8f8] ">
        <div className=" mb-12">
          <h2 className="text-2xl md:text-4xl font-semibold leading-12">
      ...
      <section className="py-16 px-4 md:px-52 ">
        <div className=" mb-12">
          <h2 className="text-2xl md:text-4xl font-semibold leading-12">
